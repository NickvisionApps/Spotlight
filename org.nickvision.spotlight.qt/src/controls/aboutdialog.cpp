...
namespace Nickvision::Spotlight::QT::Controls
{
        ...
        m_ui{ new Ui::AboutDialog() }
    {
        ...
        //Load
        m_ui->lblIcon->setPixmap({ appInfo.getVersion().getVersionType() == VersionType::Stable ? ":/resources/org.nickvision.spotlight.svg" : ":/resources/org.nickvision.spotlight-devel.svg" });
