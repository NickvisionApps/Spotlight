...
namespace Nickvision::Spotlight::Qt::Controls
{
    ...
    {
        m_ui->setupUi(this);
        setWindowTitle(_("About Spotlight"));
        //Load
        ...
        m_ui->lblAppIcon->setPixmap({ appInfo.getVersion().getVersionType() == VersionType::Stable ? ":/resources/org.nickvision.spotlight.svg" : ":/resources/org.nickvision.spotlight-devel.svg" });
