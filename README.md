[Depreciated} Nickvision has switched to development in C++/Gtkmm on Linux. Therefore, Windows-only applications, such as this one, will no longer be supported.
