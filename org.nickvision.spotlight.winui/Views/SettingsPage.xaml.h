...
namespace winrt::Nickvision::Spotlight::WinUI::Views::implementation
{
    ...
    public:
         ...
         */
        void Controller(const std::shared_ptr<::Nickvision::Spotlight::Shared::Controllers::PreferencesViewController>& controller);
        /**
    ...
    private:
         ...
         */
        void ApplyChanges();
        std::shared_ptr<::Nickvision::Spotlight::Shared::Controllers::PreferencesViewController> m_controller;
        bool m_constructing;
    };
}

namespace winrt::Nickvision::Spotlight::WinUI::Views::factory_implementation
{
