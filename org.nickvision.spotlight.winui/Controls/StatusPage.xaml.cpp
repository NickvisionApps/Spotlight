...
using namespace ::Nickvision::Spotlight::WinUI::Helpers;
...
{
    DependencyProperty StatusPage::m_glyphProperty = DependencyProperty::Register(L"Glyph", winrt::xaml_typename<winrt::hstring>(), winrt::xaml_typename<Nickvision::Spotlight::WinUI::Controls::StatusPage>(), PropertyMetadata{ winrt::box_value(L""), PropertyChangedCallback{ &StatusPage::OnPropertyChanged } });
    DependencyProperty StatusPage::m_useAppIconProperty = DependencyProperty::Register(L"UseAppIcon", winrt::xaml_typename<bool>(), winrt::xaml_typename<Nickvision::Spotlight::WinUI::Controls::StatusPage>(), PropertyMetadata{ winrt::box_value(false), PropertyChangedCallback{ &StatusPage::OnPropertyChanged } });
    DependencyProperty StatusPage::m_titleProperty = DependencyProperty::Register(L"Title", winrt::xaml_typename<winrt::hstring>(), winrt::xaml_typename<Nickvision::Spotlight::WinUI::Controls::StatusPage>(), PropertyMetadata{ winrt::box_value(L""), PropertyChangedCallback{ &StatusPage::OnPropertyChanged } });
    DependencyProperty StatusPage::m_descriptionProperty = DependencyProperty::Register(L"Description", winrt::xaml_typename<winrt::hstring>(), winrt::xaml_typename<Nickvision::Spotlight::WinUI::Controls::StatusPage>(), PropertyMetadata{ winrt::box_value(L""), PropertyChangedCallback{ &StatusPage::OnPropertyChanged } });
    DependencyProperty StatusPage::m_childProperty = DependencyProperty::Register(L"Child", winrt::xaml_typename<IInspectable>(), winrt::xaml_typename<Nickvision::Spotlight::WinUI::Controls::StatusPage>(), PropertyMetadata{ nullptr, PropertyChangedCallback{ &StatusPage::OnPropertyChanged } });
    DependencyProperty StatusPage::m_isCompactProperty = DependencyProperty::Register(L"IsCompact", winrt::xaml_typename<bool>(), winrt::xaml_typename<Nickvision::Spotlight::WinUI::Controls::StatusPage>(), PropertyMetadata{ winrt::box_value(false), PropertyChangedCallback{ &StatusPage::OnPropertyChanged } });
    ...
    {
        if(Nickvision::Spotlight::WinUI::Controls::StatusPage statusPage{ d.try_as<Nickvision::Spotlight::WinUI::Controls::StatusPage>() })
        {
