...
namespace winrt::Nickvision::Spotlight::WinUI::Controls::implementation
{
    ...
    DependencyProperty TitleBar::m_isActivatedProperty = DependencyProperty::Register(L"IsActivated", winrt::xaml_typename<bool>(), winrt::xaml_typename<Nickvision::Spotlight::WinUI::Controls::TitleBar>(), PropertyMetadata{ winrt::box_value(true), PropertyChangedCallback{ &TitleBar::OnPropertyChanged } });
    ...
    {
        if(Nickvision::Spotlight::WinUI::Controls::TitleBar titleBar{ d.try_as<Nickvision::Spotlight::WinUI::Controls::TitleBar>() })
        {
