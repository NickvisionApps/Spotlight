...
{
    DependencyProperty SettingsRow::m_glyphProperty = DependencyProperty::Register(L"Glyph", winrt::xaml_typename<winrt::hstring>(), winrt::xaml_typename<Nickvision::Spotlight::WinUI::Controls::SettingsRow>(), PropertyMetadata{ winrt::box_value(L""), PropertyChangedCallback{ &SettingsRow::OnPropertyChanged } });
    DependencyProperty SettingsRow::m_titleProperty = DependencyProperty::Register(L"Title", winrt::xaml_typename<winrt::hstring>(), winrt::xaml_typename<Nickvision::Spotlight::WinUI::Controls::SettingsRow>(), PropertyMetadata{ winrt::box_value(L""), PropertyChangedCallback{ &SettingsRow::OnPropertyChanged } });
    DependencyProperty SettingsRow::m_descriptionProperty = DependencyProperty::Register(L"Description", winrt::xaml_typename<winrt::hstring>(), winrt::xaml_typename<Nickvision::Spotlight::WinUI::Controls::SettingsRow>(), PropertyMetadata{ winrt::box_value(L""), PropertyChangedCallback{ &SettingsRow::OnPropertyChanged } });
    DependencyProperty SettingsRow::m_childProperty = DependencyProperty::Register(L"Child", winrt::xaml_typename<IInspectable>(), winrt::xaml_typename<Nickvision::Spotlight::WinUI::Controls::SettingsRow>(), PropertyMetadata{ nullptr, PropertyChangedCallback{ &SettingsRow::OnPropertyChanged } });
    ...
    {
        if(Nickvision::Spotlight::WinUI::Controls::SettingsRow settingsRow{ d.try_as<Nickvision::Spotlight::WinUI::Controls::SettingsRow>() })
        {
