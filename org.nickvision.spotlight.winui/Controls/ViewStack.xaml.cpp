...
{
    DependencyProperty ViewStack::m_pagesProperty = DependencyProperty::Register(L"Pages", winrt::xaml_typename<IObservableVector<IInspectable>>(), winrt::xaml_typename<Nickvision::Spotlight::WinUI::Controls::ViewStack>(), PropertyMetadata{ winrt::box_value(winrt::single_threaded_observable_vector<IInspectable>()) });
    ...
    void ViewStack::CurrentPage(const winrt::hstring& pageName)
    {
        ...
        {
            if(Nickvision::Spotlight::WinUI::Controls::ViewStackPage page{ obj.try_as<Nickvision::Spotlight::WinUI::Controls::ViewStackPage>() })
            {
