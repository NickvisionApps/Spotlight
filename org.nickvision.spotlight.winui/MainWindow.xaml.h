...
namespace winrt::Nickvision::Spotlight::WinUI::implementation 
{
    ...
    public:
         ...
         */
        void SetController(const std::shared_ptr<::Nickvision::Spotlight::Shared::Controllers::MainWindowController>& controller, Microsoft::UI::Xaml::ElementTheme systemTheme);
        /**
