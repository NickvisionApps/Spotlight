...
namespace winrt::Nickvision::Spotlight::WinUI::implementation 
{
    ...
    public:
         ...
         */
        void SetController(const std::shared_ptr<::Nickvision::Spotlight::Shared::Controllers::PreferencesViewController>& controller);
        /**
...
namespace winrt::Nickvision::Spotlight::WinUI::factory_implementation 
{
