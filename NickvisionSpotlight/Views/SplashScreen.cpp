...
namespace NickvisionSpotlight::Views
{
	...
	SplashScreen::SplashScreen(MainWindow* parent) : wxDialog(parent, IDs::DIALOG, "", wxDefaultPosition, { 500, 300 }, 0), m_mainWindow(parent)
	{
		...
		m_panelTitle->SetBackgroundColour({ 0, 128, 128 });
		//Title
		m_lblTitle = new wxStaticText(m_panelTitle, IDs::LBL_TITLE, "Nickvision Spotlight");
		...
		//Description
		m_lblDescription = new wxStaticText(m_panelTitle, IDs::LBL_DESCRIPTION, "A utility for working with Windows Spotlight images.");
		...
		//==App Info==//
		//Version
		m_lblVersion = new wxStaticText(this, IDs::LBL_VERSION, "Version: 2022.2.0-alpha4");
		//Copyright
