...
Spotlight is built using C++20 and platform-native user interface libraries. With these technologies, Spotlight is built for the Windows operating system.
